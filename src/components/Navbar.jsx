...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4 font-medium'>
        ...
        <img src={assets.logo} alt="" srcset="" className='w-50'/>
        ...
        <div className='flex items-center gap-6'>
            ...
            <img src={assets.search_icon} alt="" srcset="" className='w-5 cursor-pointer'/>
            ...
            <Link to='/cart' className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-amber-900 text-white aspect-square rounded-full text-[8px]'>10</p>
            </Link>
